...
- `public/logos/`: the agent harness logos flown by the spaceships in the
  front page animation (Claude Code, Hermes, OpenCode)
...
carry a hand-bumped version query (`/styles.css?v=7`, `/game.js?v=13`,
